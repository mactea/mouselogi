...
@echo off
call "$vcvars" >nul
cl.exe /nologo /utf-8 /O2 /MT /EHsc /W4 /DUNICODE /D_UNICODE /Fo"$outDir\MouseLogiNative.obj" /Fe"$exe" "$source" user32.lib kernel32.lib shell32.lib gdi32.lib hid.lib setupapi.lib psapi.lib /link /SUBSYSTEM:WINDOWS /OPT:REF /OPT:ICF
